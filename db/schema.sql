...
--
-- `cap_micro_usd` doubles as the prepaid WALLET BALANCE: it starts at the $0.05
...
CREATE TABLE IF NOT EXISTS user_budget (
  ...
  cap_micro_usd      BIGINT NOT NULL DEFAULT 50000, -- $0.05 free trial + Stripe top-ups; the wallet balance ceiling
