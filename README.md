...
Only `AI_GATEWAY_API_KEY` is required. Four configured models stream strict structured IR triage recommendations in parallel via [Vercel AI Gateway](https://vercel.com/ai-gateway).

## Demo script

1. Select preset **#2 Pelvic trauma**
2. Click **Run Triage** (blinded Model A–D)
3. Toggle **Reveal models** and review the **Agreement** strip
